...
const CourseDetails = () => {
  ...
  const [isCourseEnrolling, setIsCourseEnrolling] = useState(false);

  const handleEnrollUser = async () => {
    // console.error("token",token);
    // console.error("courseId",courseId);
    const data = { courseId, token };

    if (token) {
      setIsCourseEnrolling(true);
  ...
  //   const handleEnrollUser = async () => {
  //     // console.error("Token:", token); // Log token to verify it's being passed correctly
  //     // console.error("Course ID:", courseId); // Log course ID to verify it's being passed correctly
            ...
            {ACCOUNT_TYPE.INSTRUCTOR !== user?.accountType && (
              <>
                {alreadyEnrolled ? (
                  ...
                  <button onClick={handleEnrollUser} className="yellowButton">
                    {/* Buy Now */}
                    Enroll Now
                  </button>
                )}
